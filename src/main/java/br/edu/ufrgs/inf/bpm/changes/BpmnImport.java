...
public class BpmnImport implements ImportPlugin /*LogReaderConnectionImportPlugin*/ {
    ...
    public MiningResult importFile(InputStream input) throws IOException {
        ...
        if (doc != null) {
            BpmnGraph graph = createBpmnGraph(doc);
    ...
    public BpmnGraph createBpmnGraph(Document doc) {
        Element root = doc.getDocumentElement();
        return createBpmnGraph(root);
    }

    public BpmnGraph createBpmnGraph(Element element) {
        BpmnGraph graph = null;
        BpmnProcessModel mainProcess = new BpmnProcessModelAdaptation(null, element);
