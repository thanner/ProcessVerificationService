...
public abstract class TraceMetric extends UnaryMetric {
	 ...
	 * @param aDescription
	 */
	public TraceMetric(String aName, String aDescription, LogSummary logSummary) {
		super(aName, aDescription, logSummary.getNumberOfProcessInstances());
		normalized = null;
	}
	
	public abstract void measure(LogReader log);
