...
public class ControlPanel extends JPanel {
	...
	public ControlPanel(AnimationFrame frame) {
		...
		zoomSlider.setUI(new SlickerSliderUI(zoomSlider, 
				new Color(40, 40, 40),
				new Color(70, 70, 70),
				new Color(0, 0, 0),
				new Color(80, 80, 80),
		...
		fullScreenButton.setColors(new Color(255, 0, 0), new Color(220, 220, 220), new Color(140, 140, 140), new Color(0, 0, 0), new Color(20, 20, 20), new Color(30, 30, 30));
