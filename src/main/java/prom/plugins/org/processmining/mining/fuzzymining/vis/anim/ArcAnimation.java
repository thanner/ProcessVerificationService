...
public class ArcAnimation {
	...
	public ArcAnimation(String id, String sourceId, String targetId, GGCurve curve) {
		this.id = id;
	...
	protected void insertKeyframeAtPosition(int position, long time) {
		...
		if(position > 0) {
			List<TokenAnimation> tokenAnimations = keyframeList.get(position - 1).getTokenAnimations();
