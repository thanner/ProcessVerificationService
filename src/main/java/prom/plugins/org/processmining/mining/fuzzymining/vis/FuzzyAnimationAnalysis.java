 ...
 *
 */
public class FuzzyAnimationAnalysis extends JPanel implements AnalysisPlugin, Provider {
	...
	public JComponent analyse(AnalysisInputItem[] inputs) {
		...
		final JComboBox graphSelector = new JComboBox(modelMap.keySet().toArray());
				...
				for(ProvidedObject providedObject : providedObjects) {
					for(Object object : providedObject.getObjects()) {
						if(object instanceof FuzzyGraph) {
							modelMap.put(frame.getTitle() + " - " + providedObject.getName(), (FuzzyGraph)object);
	...
	public ProvidedObject[] getProvidedObjects() {
		if(animationFrame != null) {
			return new ProvidedObject[] {
				new ProvidedObject("Fuzzy Model Animation", new Object[] { animationFrame.getAnimation() }),
				new ProvidedObject("Animation graph", new Object[] { animationFrame.getGraph() }),
				new ProvidedObject("Animation log", new Object[] { animationFrame.getLog() })
			};
		} else {
			return new ProvidedObject[] {};
		}
