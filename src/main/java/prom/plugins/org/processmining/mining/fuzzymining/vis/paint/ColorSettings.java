...
public class ColorSettings {
	...
	public static Color mix(Color a, Color b, float percentage) {
		if(percentage <= 0f) {
			...
			float red = (antiPercentage * a.getRed()) + (percentage * b.getRed());
			float green = (antiPercentage * a.getGreen()) + (percentage * b.getGreen());
			float blue = (antiPercentage * a.getBlue()) + (percentage * b.getBlue());
			float alpha = (antiPercentage * a.getAlpha()) + (percentage * b.getAlpha());
	...
	public static ColorSettings SETTINGS_DAY = new ColorSettings(
	...
	public ColorSettings(Color canvasBackground, Color passiveEdgeBackground,
			...
			Color passiveTaskForeground, Color passiveTaskBorder, Color activeTaskBackground,
			Color activeTaskForeground, Color activeTaskBorder, Color tokenLabel,
			Color taskBadgeForeground, Color taskBadgeBackgroundSwallowed,
			Color taskBadgeBackgroundEmerged, Color taskBadgeBackgroundTraversed,
