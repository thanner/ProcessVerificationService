...
public class MutableFuzzyGraph implements FuzzyGraph {
	...
	public MutableFuzzyGraph(UnaryMetric nodeSignificance, BinaryMetric edgeSignificance,
			BinaryMetric edgeCorrelation, LogEvents events) {
	...
	public MutableFuzzyGraph(MetricsRepository metrics) {
		this(metrics.getAggregateUnaryMetric(), 
				metrics.getAggregateSignificanceBinaryMetric(),
				metrics.getAggregateCorrelationBinaryMetric(), 
				metrics.getLogReader().getLogSummary().getLogEvents());
	}
	...
	/* (non-Javadoc)
	 * @see org.processmining.mining.fuzzymining.graph.FuzzyGraph#getNumberOfInitialNodes()
	 */
	...
	/* (non-Javadoc)
	 * @see org.processmining.mining.fuzzymining.graph.FuzzyGraph#getPrimitiveNode(int)
	 */
	...
	/* (non-Javadoc)
	 * @see org.processmining.mining.fuzzymining.graph.FuzzyGraph#getNodeMappedTo(int)
	 */
	...
	/* (non-Javadoc)
	 * @see org.processmining.mining.fuzzymining.graph.FuzzyGraph#getClusterNodes()
	 */
	...
	/* (non-Javadoc)
	 * @see org.processmining.mining.fuzzymining.graph.FuzzyGraph#getBinarySignificance(int, int)
	 */
	...
	/* (non-Javadoc)
	 * @see org.processmining.mining.fuzzymining.graph.FuzzyGraph#getBinaryCorrelation(int, int)
	 */
	...
	public void hidePermanently(Node node) {
		if(node instanceof ClusterNode) {
			...
			HashSet<Node> primitives = new HashSet<Node>(((ClusterNode)node).getPrimitives());
	...
	/* (non-Javadoc)
	 * @see org.processmining.mining.fuzzymining.graph.FuzzyGraph#getMinimalNodeSignificance()
	 */
	...
	/* (non-Javadoc)
	 * @see org.processmining.mining.fuzzymining.graph.FuzzyGraph#getSortedNodeSignificances()
	 */
	 ...
	 */
	/* (non-Javadoc)
	 * @see org.processmining.mining.fuzzymining.graph.FuzzyGraph#writeToDot(java.io.Writer)
	 */
	...
	/* (non-Javadoc)
	 * @see org.processmining.mining.fuzzymining.graph.FuzzyGraph#getGraphPanel()
	 */
	...
	/* (non-Javadoc)
	 * @see org.processmining.mining.fuzzymining.graph.FuzzyGraph#getEdgeCorrelationMetric()
	 */
	...
	/* (non-Javadoc)
	 * @see org.processmining.mining.fuzzymining.graph.FuzzyGraph#getEdgeSignificanceMetric()
	 */
	...
	/* (non-Javadoc)
	 * @see org.processmining.mining.fuzzymining.graph.FuzzyGraph#getNodeSignificanceMetric()
	 */
	...
	public Object clone() {
		...
		for(int i=0; i<this.events.size(); i++) {
			...
			clone.events.add(new LogEvent(event.getModelElementName(), 
	...
	/* (non-Javadoc)
	 * @see org.processmining.mining.fuzzymining.graph.FuzzyGraph#getAttribute(java.lang.String)
	 */
	...
	/* (non-Javadoc)
	 * @see org.processmining.mining.fuzzymining.graph.FuzzyGraph#getAttributeKeys()
	 */
	...
	/* (non-Javadoc)
	 * @see org.processmining.mining.fuzzymining.graph.FuzzyGraph#resetAttributes()
	 */
	...
	/* (non-Javadoc)
	 * @see org.processmining.mining.fuzzymining.graph.FuzzyGraph#setAttribute(java.lang.String, java.lang.String)
	 */
