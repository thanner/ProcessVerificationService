...
public class ArcAnimationKeyframe {
	...
	/**
	 * Adds the provided token animation at the logical
	 * position within the list already contained. The
	 * animations are sorted in order of their finishing,
	 * i.e. the one finishing first is also the first
	 * element in the list.
	 * @param anim Token animation to be added
	 */
