...
public class AnimationTimer {
	...
	public long translateModelTimeToRealTime(long modelTime) {
		double percentage = (double)(modelTime - this.modelTimeStart) / (double)(this.modelTimeEnd - this.modelTimeStart);
		return realTimeStart + (long)(percentage * (double)(realTimeEnd - realTimeStart));
	}
	...
	protected void updateData() {
		relativePosition = (double)(System.currentTimeMillis() - realTimeStart) / (double)(realTimeEnd - realTimeStart);
	...
	protected void updateRealTimes() {
		...
		this.realTimeStart = currentTime - (long)((double)realDuration * this.relativePosition);
	...
	public synchronized void setRelativePosition(double relativePosition) {
		...
		if(updateThread == null) {
			long modelTime = modelTimeStart + (long)((double)(modelTimeEnd - modelTimeStart) * relativePosition);
