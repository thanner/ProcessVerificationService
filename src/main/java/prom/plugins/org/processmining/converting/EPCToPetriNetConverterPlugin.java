...
public class EPCToPetriNetConverterPlugin implements ConvertingPlugin {
	...
	public String getHtmlDescription() {
		return "<p> <b>Plug-in: EPC to Petrinet</b>"+
				...
				org.processmining.framework.util.Constants.get_BVD_URLString("EPC_verification","this paper")+
				...
				"be found "+
				org.processmining.framework.util.Constants.get_BVD_URLString("SAP_reduction","here");
	}
