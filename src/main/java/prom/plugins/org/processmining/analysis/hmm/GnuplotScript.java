...
/**
 * Class encapsulating gnuplot script files. 
 * Provides abstract interface for creation and plotting. 
 */
public class GnuplotScript {
			
	public enum PlotType{ lines, points }
	 ...
	 * @param datfileName the datfile to be plotted without suffix. It is assumed to be in the same folder 
	 * as the script and to have the suffix .dat
	 * @param plotName the name by which the plotted data should be represented in the graph
	 */
	...
	/**
	 * Finishes and closes the gnuplot file. 
	 * Should be called after finishing plotting.
	 */
	public void finish() {
		try {
			script.flush();
