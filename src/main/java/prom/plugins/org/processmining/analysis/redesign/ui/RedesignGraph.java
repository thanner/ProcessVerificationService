...
public class RedesignGraph extends GGGraph {
	...
	private static GGEdgePainter edgePainter = new GGEdgeGenericPainter(lineColor, labelColor);
	
	/**
	 * Creates the initial tree to display in the UI
	 * @param parent RedesignAnalysisUI the UI that displays the tree
	 * @param original HLPetriNet the model associated to the only node in the tree
	 */
	 ...
	 * 
	 * @param parent HLPetriNet the model that has been redesigned
	 * @param model HLPetriNet the alternative model, i.e., the result of the redesign
	 * @param type RedesignType the type of redesign
	 * @return
	 */
	public RedesignNode addRedesign(HLPetriNet parent, HLPetriNet model, RedesignType type) {
	 ...
	 * label and id.
	 * The node is connected to the parent node, i.e., the node where the redesign
	 * that resulted in the alternative model has been started.
	 * 
	 * @param parent RedesignNode the parent node which model is redesigned
	 * @param model HLPetriNet the alternative model, i.e., the result of the redesign
	 * @param label String[] the label of the new node
	 * @param id int the id of the new node
	 * @return RedesignNode the created node that is associated to the alternative model
	 */	
	public RedesignNode addRedesign(RedesignNode parent, HLPetriNet model, String[] label, int id) {
	...
	/**
     * Returns the redesign nodes which are currently selected in the GUI
     * of this graph.
     *
     * @return ArrayList<RedesignNode> selectedRedesignNodes the selected redesign nodes
     */
     ...
     * of this graph.
     *
     * @return ArrayList<RedesignNode> simRedesignNodes the redesign nodes selected for simulation
     */
    ...
    /**
     * Returns the redesign nodes which are a direct or indirect successor of 
     * a particular node
     *
     * @return ArrayList<RedesignNode> allSuccessors the succeeding redesign nodes
     * NB. Dit gaat ook toe naar het vinden van de transitive closure
     */
    ...
    public void getDirectSuccessors(RedesignNode node, ArrayList<RedesignNode> allSuccessors) {
    ...
    /**
     * Removes all direct and indirect successors of a particular node in the graph
     */
     ...
     * 
     * @param model HLPetriNet the model to display
     * @param label String[] the label of the new node
     * @param id int the id of the new node
	...
	private RedesignNode createNode(HLPetriNet model, String[] label, int id) {
		...
		/**
		 * set the original node to selectedForSimulation, because
		 * the node should always be simulated for comparison with other nodes 
		 */
