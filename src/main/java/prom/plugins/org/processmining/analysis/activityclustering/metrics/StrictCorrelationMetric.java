...
public class StrictCorrelationMetric implements CorrelationMetric {
	...
	/**
	 * @param enforceSameOriginator the enforceSameOriginator to set
	 */
	...
	/**
	 * @param useProximity the useProximity to set
	 */
	...
	/**
	 * @param proximityZone the proximityZone to set
	 */
	...
	/**
	 * @param useDataAttributes the useDataAttributes to set
	 */
	...
	/**
	 * @param useDataValues the useDataValues to set
	 */
	...
	/**
	 * @param useEventNames the useEventNames to set
	 */
	...
	/**
	 * @param useEventTypes the useEventTypes to set
	 */
	...
	/* (non-Javadoc)
	 * @see org.processmining.analysis.activityclustering.metrics.CorrelationMetric#measureCorrelation(org.processmining.framework.log.AuditTrailEntry, org.processmining.framework.log.AuditTrailEntry)
	 */
	...
	protected double measureDataValues(AuditTrailEntry a, AuditTrailEntry b) {
		...
		for(String key : aData.keySet()) {
			if(bData.containsKey(key) == true) {
				similarity += StringSimilarity.similarity(aData.get(key), bData.get(key));
			}
		}
		similarity /= size;
		return similarity;
