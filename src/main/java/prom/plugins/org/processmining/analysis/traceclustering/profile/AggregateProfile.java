...
public class AggregateProfile extends Profile {
	...
	/* (non-Javadoc)
	 * @see org.processmining.analysis.traceclustering.profile.Profile#getDistanceMatrix(org.processmining.analysis.traceclustering.distance.DistanceMetric)
	 */
	@Override
	public DistanceMatrix getDistanceMatrix(DistanceMetric metric, Progress progress) {
		if(distanceMatrix == null) {
			...
			for(Profile profile : profiles) {
				...
				progress.setNote("Measuring " + profile.getName() + " using " + metric.getName() + " metric...");
				progressCounter++;
	...
	/* (non-Javadoc)
	 * @see org.processmining.analysis.traceclustering.profile.Profile#getItemKeys()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.processmining.analysis.traceclustering.profile.Profile#getValue(int, int)
	 */
	@Override
	public double getValue(int instanceIndex, int itemIndex) {
		...
		double normalizationFactor = normalizationMaximum / profile.getNormalizationMaximum();
		double value = profile.getValue(instanceIndex, origItem) * normalizationFactor;
		return value;
	}

	/* (non-Javadoc)
	 * @see org.processmining.analysis.traceclustering.profile.Profile#getValue(int, java.lang.String)
	 */
	@Override
