...
public class GZipCompressionDistance extends StringDistanceMetric {
	...
	/* (non-Javadoc)
	 * @see org.processmining.analysis.traceclustering.distance.sequence.StringDistanceMetric#getDistance(java.lang.String, java.lang.String)
	 */
	@Override
	...
	protected int compressionSize(String string) {
		...
		try {
			DataOutputStream daos = new DataOutputStream(new GZIPOutputStream(baos));
