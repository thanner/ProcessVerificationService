...
public class SessionOptions {
	...
	public enum DisplayType {
		MIN("Minimum", true), 
		MAX("Maximum", true), 
		ARITHMETIC_MEAN("Arithmetic Mean", true),
		VARIANCE("Variance", false),
		STANDARD_DEVIATION("Standard Deviation", false),
		GEOMETRIC_MEAN("Geometric Mean", false),
		SUM("Sum", true),
		NO_MEASUREMENTS("No. of Measurements", false);	
	...
	public SessionOptions(GuiNotificationTarget parent) {
		myDisplayProperty = new GUIPropertyListEnumeration(
				"Display in graph: ", "Determine which result type should be visualized in graph", 
	 ...
	 */
	public static double getStatisticValue(SummaryStatistics statistic, DisplayType type) {
