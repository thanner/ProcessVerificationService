...
public class ExecutionTimes {
	...
	public ExecutionTimes(boolean useTaskOntologies, boolean useOriginatorOntologies) {
	...
	public void add(String taskLabel, String originatorLabel, Set<String> taskMRs, Set<String> origMRs, double executionTime) {
		Set<String> taskList = useTaskOntologies ? taskMRs : new HashSet<String>(Arrays.asList(new String[] { taskLabel }));
		Set<String> originatorList = useOriginatorOntologies ? origMRs : new HashSet<String>(Arrays.asList(new String[] { originatorLabel }));
		
		for (String task : taskList) {
			for (String originator : originatorList) {
				rawMeasurements.add(new ExecutionTimeMeasurement(task, originator, executionTime));
