...
public class AteReference extends AuditTrailEntry {
	...
	protected AuditTrailEntry dereference() {
		try {
			return log.getInstance(processInstanceIndex).getAuditTrailEntryList().get(eventIndex);
		} catch (IOException e) {
			//  not much to do here...
			e.printStackTrace();
			return null;
	...
	public boolean equals(Object o) {
		if(o instanceof AteReference) {
			...
			return (log == other.log && 
					processInstanceIndex == other.processInstanceIndex && 
	...
	/* (non-Javadoc)
	 * @see org.processmining.framework.log.AuditTrailEntry#getElementModelReferences()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.processmining.framework.log.AuditTrailEntry#getOriginatorModelReferences()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.processmining.framework.log.AuditTrailEntry#getTypeModelReferences()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.processmining.framework.log.AuditTrailEntry#setElementModelReferences(java.util.List)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.processmining.framework.log.AuditTrailEntry#setOriginatorModelReferences(java.util.List)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.processmining.framework.log.AuditTrailEntry#setTypeModelReferences(java.util.List)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.processmining.framework.log.LogEntity#setDataAttributes(org.processmining.framework.log.DataSection)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.processmining.framework.log.LogEntity#setModelReferences(java.util.List)
	 */
	@Override
