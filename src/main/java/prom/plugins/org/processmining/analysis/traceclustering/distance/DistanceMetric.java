...
public abstract class DistanceMetric {
	...
	protected DistanceMetric(String aName, String aDescription) {
		name = aName;
	...
	public abstract double getDistance(InstancePoint pointA, InstancePoint pointB);
	
	public abstract DistanceMatrix getDistanceMatrix(Profile profile);
