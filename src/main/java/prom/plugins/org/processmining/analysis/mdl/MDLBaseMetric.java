...
public abstract class MDLBaseMetric {
	 ...
	 * @param aDescription the given description
	 * @see #getName()
	 * @see #getDescription()
	 * @see #getEncodingCost()
	 */
	 ...
	 * This name should be meaningful enough to be e.g. displayed in a GUI element that
	 * allows to choose a specific metric from a list of available ones.
	...
	/**
	 * A description that allows the user of this metric to understand sufficiently what
	 * distinguishes this particular metrics from other available metrics.
	 ...
	 * @param progress the progress panel to indicate status of metric calculation
	 * @return the cost of encoding the event log in the given process model
	 * @param aNet the given Petri net model 
	 * @param aLog the given Event log (can be null if not needed)
	 */
	public abstract int getEncodingCost(ProgressPanel progress, PetriNet aNet, LogReader aLog);
	
	/**
	 * Helper method to calculate upper bound of encoding costs.
	 * @param value the double value of which the upper bound should be determined
