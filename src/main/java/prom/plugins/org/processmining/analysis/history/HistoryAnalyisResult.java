...
/**
 * This result frame constitutes only a temporary solution and
 * mainly serves as a provider object for the history-enhanced
 * execution log, which can be either exported or directly 
 * used as input for further, history-based analysis.
 * 
 * @author Anne Rozinat
 */
public class HistoryAnalyisResult extends JPanel implements Provider {
	...
	private void jbInit() {
		...
		this.add(new JLabel("<html><br>The given execution log has been enhanced with counting measures for each log event in the " +
	...
	public ProvidedObject[] getProvidedObjects() {
		try {
			...
			objects.add(new ProvidedObject("History-enhanced Log", new Object[] {myLog}));
