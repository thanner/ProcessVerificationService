...
public class MXMLibLogExport implements ExportPlugin {
	...
	/* (non-Javadoc)
	 * @see org.processmining.exporting.ExportPlugin#export(org.processmining.framework.plugin.ProvidedObject, java.io.OutputStream)
	 */
	public void export(ProvidedObject object, OutputStream output)
		...
		if(log == null) {
			throw new AssertionError("Provided object to export does not have a log reader!");
		}
