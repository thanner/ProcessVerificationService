...
public class ConvertInternalAction extends AbstractAction {
	...
	public ConvertInternalAction(ConvertingPlugin algorithm, ProvidedObject object) {
		super(RuntimeUtils.stripHtmlForOsx("<html>" /*+ object.getName() + " using<br>&nbsp;&nbsp;&nbsp;"*/ +
				algorithm.getName() +
				"</html>"));
	...
	public void actionPerformed(ActionEvent e) {
		...
		SwingWorker worker = new SwingWorker() {
			...
			public Object construct() {
				...
				try {
					if (algorithm instanceof DoNotCreateNewInstance) {
						...
						result = ((ConvertingPlugin) algorithm.getClass().newInstance()).convert(object);
					}
			...
			public void finished() {
				...
				MainUI.getInstance().createConversionResultFrame(algorithm, result);
			}
		};
		worker.start();
	}
