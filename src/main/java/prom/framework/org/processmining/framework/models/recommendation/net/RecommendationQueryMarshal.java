...
public class RecommendationQueryMarshal {
	...
	public String marshal(RecommendationQuery query) throws Exception {
		...
		if (query.getFilterUsers() != null ||
				query.getFilterTasks() != null ||
		...
		if (query.getAvailableTasks() != null ||
			...
			if (query.getAvailableUsers() != null) {
				Tag availableResourcesTag = engineStateTag.addChildNode("Resources");
			...
			if (query.getAvailableTasks() != null) {
				...
				for (LogEvent task : query.getAvailableTasks()) {
					Tag logEventTag = availableUsersTag.addChildNode("LogEvent");
		...
		for (AuditTrailEntry entry : query.getAuditTrail()) {
			...
			if (entry.getTimestamp() != null) {
				...
				timestamp.addTextNode(RecommendationQueryMarshal.dateFormat.format(entry.
						getTimestamp()) + "+01:00");
			}
	 ...
	 * @throws IOException
	 */
	protected void addDataSection(Tag parentNode, Map<String,
	...
	protected class RecommendationQueryHandler extends DefaultHandler {
		...
		public void startElement(String uri, String localName, String qName,
			...
			if (tagName.equalsIgnoreCase("Filter")) {
				...
				String processInstanceId = attributes.getValue("processInstanceId");
				query = new RecommendationQuery(id, processId, processInstanceId);
		...
		public void endElement(String uri, String localName, String qName) throws SAXException {
			...
			if (tagName.equalsIgnoreCase("Filter")) {
				...
				if (inFilter == true) {
					query.addFilterTask(currentLogEventTask, buffer.toString().trim());
				} else if (inEngineState == true) {
					query.addAvailableTask(currentLogEventTask, buffer.toString().trim());
				}
		...
		public void error(SAXParseException arg0) throws SAXException {
			System.err.println("Error parsing recommendation query (unmarshalling):");
			arg0.printStackTrace();
		}

		public void fatalError(SAXParseException arg0) throws SAXException {
			System.err.println("Fatal error parsing recommendation query (unmarshalling):");
			arg0.printStackTrace();
			query = null;
		}
