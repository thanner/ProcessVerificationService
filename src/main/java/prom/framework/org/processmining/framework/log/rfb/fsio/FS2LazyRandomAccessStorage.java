...
/**
 * Lazy implementation of the random access storage in NikeFS2:
 * Blocks are copied as late as possible (soft copies), which makes
 * sense due to the immense creation of log reader copies in ProM.
 * 
...
public class FS2LazyRandomAccessStorage extends FS2RandomAccessStorage {
	...
	public synchronized void deregisterSoftCopy(FS2LazyRandomAccessStorage copycat) {
	...
	public synchronized void alertSoftCopies() throws IOException {
		...
		FS2LazyRandomAccessStorage[] copies = softCopies.toArray(new FS2LazyRandomAccessStorage[softCopies.size()]);
	...
	/* (non-Javadoc)
	 * @see org.processmining.framework.log.rfb.fsio.FS2RandomAccessStorage#close()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.processmining.framework.log.rfb.fsio.FS2RandomAccessStorage#copy()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.processmining.framework.log.rfb.fsio.FS2RandomAccessStorage#write(byte[], int, int)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.processmining.framework.log.rfb.fsio.FS2RandomAccessStorage#write(byte[])
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.processmining.framework.log.rfb.fsio.FS2RandomAccessStorage#write(int)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.processmining.framework.log.rfb.fsio.FS2RandomAccessStorage#writeBoolean(boolean)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.processmining.framework.log.rfb.fsio.FS2RandomAccessStorage#writeByte(int)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.processmining.framework.log.rfb.fsio.FS2RandomAccessStorage#writeBytes(java.lang.String)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.processmining.framework.log.rfb.fsio.FS2RandomAccessStorage#writeChar(int)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.processmining.framework.log.rfb.fsio.FS2RandomAccessStorage#writeChars(java.lang.String)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.processmining.framework.log.rfb.fsio.FS2RandomAccessStorage#writeDouble(double)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.processmining.framework.log.rfb.fsio.FS2RandomAccessStorage#writeFloat(float)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.processmining.framework.log.rfb.fsio.FS2RandomAccessStorage#writeInt(int)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.processmining.framework.log.rfb.fsio.FS2RandomAccessStorage#writeLong(long)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.processmining.framework.log.rfb.fsio.FS2RandomAccessStorage#writeShort(int)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.processmining.framework.log.rfb.fsio.FS2RandomAccessStorage#writeUTF(java.lang.String)
	 */
	@Override
