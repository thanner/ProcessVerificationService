...
/**
 * Provides a simple timer facility, to measure the duration of
 * tasks.
 *
...
public class StopWatch {
	...
	/**
	 * Constants encoding the duration of
	 * time units in millisconds.
	 */
	...
	/**
	 * Formats a duration, given in milliseconds, to a
	 * human-readable string (verbose)
	 * @param timeInMillis
	 * @return
	 */
	...
	/**
	 * Finishes measuring the duration
	 * (sets finish time)
	 */
