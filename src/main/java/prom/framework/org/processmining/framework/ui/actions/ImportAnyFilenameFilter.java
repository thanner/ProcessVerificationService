 ...
 *
 */
public class ImportAnyFilenameFilter extends FileFilter implements FilenameFilter {
	...
	public boolean accept(File dir, String name) {
		...
		MxmlFilenameFilter mxmlFilter = new MxmlFilenameFilter();
		if(mxmlFilter.accept(dir, name)) {
			return true;
		}
	...
	public String getDescription() {
		return "Files supported by ProM";
	}
