 ...
 * <code>AuditTrailEntryList</code> interface to the legacy <code>AuditTrailEntries</code>
 * interface.
...
public class AuditTrailEntryListProxy implements AuditTrailEntryList {
	...
	/**
	 * Creates a new proxy instance, backed by the provided audit trail entry list
	 * and with its iterator set to the specified position in the list.
	 * @param ateList
	 * @param startPosition
	 */
	 ...
	 */
	public AuditTrailEntry get(int index) throws IndexOutOfBoundsException, IOException {
	 ...
	 */
	public void insert(AuditTrailEntry ate, int index) throws IndexOutOfBoundsException, IOException {
	 ...
	 */
	public AuditTrailEntry remove(int index) throws IndexOutOfBoundsException, IOException {
	 ...
	 */
	public AuditTrailEntry replace(AuditTrailEntry newAte, int index) throws IndexOutOfBoundsException, IOException {
		// move iterator to index position
		myAtes.reset();
		int i = 0;
		while (myAtes.hasNext()) {
	...
	public boolean isTainted() {
		return false; // classic ate list is not organized in such a way that it could be tainted
	}
	...
	public boolean consolidate() throws IOException {
		return true; // classic ate list is not organized in such a way that it could be consolidated
	}
	...
	public void cleanup() throws IOException {
		// classic ate list is not organized in such a way that it could be cleaned up
	}
}
