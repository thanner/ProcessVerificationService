...
public class DotTools {
	...
	public synchronized InputStream runDot(List<String> params, String input) throws IOException {
		// put input into temporary file
		File dotFile = File.createTempFile("DotTmp", "tmp");
		BufferedOutputStream tmpOs = new BufferedOutputStream(new FileOutputStream(dotFile));
	...
	public synchronized InputStream runDot(List<String> params, File dotFile) throws IOException {
		// extend params
	...
	public synchronized String getDotResultString(List<String> params, String input) throws IOException {
	...
	public synchronized Graph getGraphFromDot(DotFileWriter writer, List<String> params) throws Exception {
