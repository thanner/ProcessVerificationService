...
import org.processmining.framework.ui.ClassicOpenLogSettings;

/**
 * @author Christian W. Guenther (christian@deckfour.org)
 *
 */
public class ClassicLogDialog implements AnalysisPlugin {
	...
	public JComponent analyse(AnalysisInputItem[] inputs) {
		...
		// open GUI
		if(log != null) {
			settings = new ClassicOpenLogSettings(log);
	...
	public String getName() {
		return "Open log with classic dialog";
	}
