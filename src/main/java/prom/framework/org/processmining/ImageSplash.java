...
public class ImageSplash extends JWindow implements ProMSplash {
	...
	ImageSplash() throws HeadlessException {
		...
		imgBg = Toolkit.getDefaultToolkit().createImage(imgPath + "splash_background.png");
		imgLogo = Toolkit.getDefaultToolkit().createImage(imgPath + "splash_logo.png");
		// Load the image
		...
		gradient = new GradientPaint(0, progressY, ImageSplash.COLOR_PROGRESS1, 0,
				   progressY + progressHeight, ImageSplash.COLOR_PROGRESS2);
		// make visible
	...
	public void paint(Graphics g) {
		...
		int pBarWidth = ((progressWidth - 3) * progress) / ImageSplash.MAX_PROGRESS;
		g2d.fillRect(progressX + 2, progressY + 2, pBarWidth, progressHeight - 3);
