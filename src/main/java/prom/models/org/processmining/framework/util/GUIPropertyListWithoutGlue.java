...
/**
 * Needed without glue for the Decision Miner. 
 * TODO: Solve differently as these GUI properties grow too large and too specific - redesign GUI property pool!
 * 
 * @author Anne Rozinat
 */
public class GUIPropertyListWithoutGlue extends GUIPropertyListEnumeration {
	 ...
	 */
	public GUIPropertyListWithoutGlue(String name, String description, List values,
