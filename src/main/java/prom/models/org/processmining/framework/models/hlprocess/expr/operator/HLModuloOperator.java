...
/**
 * Numeric % operator (rest of whole integer divisionn).
 * <p>Requires at exactly two numeric input operands to be evaluated. 
 */
public class HLModuloOperator extends HLExpressionOperator {

	/**
	 * Constructor.
	 */
	public HLModuloOperator() {
		minNumberInputs = 2;
		maxNumberInputs = 2;
	}
	...
	public String evaluateToString() {
		...
		return "(" + first.evaluateToString() + " Mod " + second.evaluateToString() + ")";
	}
