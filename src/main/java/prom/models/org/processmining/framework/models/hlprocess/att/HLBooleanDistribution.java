 ...
 * <p>Per default assigns equal probability to both <code>true</code> and 
...
public class HLBooleanDistribution implements HLAttributeValue {
	 ...
	 * <p>As a consequence it becomes more likely relative to the other 
	 * value.
	 * @param aValue the value to be increased in likelyhood
	 */
	 ...
	 * <p>Note that for a default boolean distribution the relative
	 * frequency 1 will be returned for both <code>true</code> and 
	 * <code>false</code> values. 
	 * <p>The likelihood of a value can be increased by calling the
	 * method {@link #addFrequency(boolean)}.
	 * @param aValue the value for which the relative frequency is 
	 * to be obtained
	 * @return the relative frequency for the given value (needs to be 
	 * evaluated with respect to the frequency of the counter value
	...
	/**
	 * Sets the relative frequency of the value <code>true</code>
	 * to the given value
	 * @param aFreq the new frequency for 'true'
	 */
	...
	/**
	 * Sets the relative frequency of the value <code>false</code>
	 * to the given value
	 * @param aFreq the new frequency for 'false'
	 */
	 ...
	 * This is based on the relative frequency measured for <code>true</code> and 
	 * <code>false</code> values.
	 * @return the probability of this distribution for the value being <code>true</code>
	 */
	...
	public boolean equals(Object o) {
		if (this == o) {
			...
			return (freqTrueValue == ((HLBooleanDistribution) o).freqTrueValue 
					&& freqFalseValue == ((HLBooleanDistribution) o).freqFalseValue);
		}
	}
