...
/**
 * Visualizes an arbitrary model graph in the context of a high level process.
 * <br>
...
public class HLVisualization implements GuiDisplayable {
	...
	/** the model graph of the current visualization is kept in order to enable the highlighting of certain nodes in it */
	protected ModelGraphPanel myModelGraphPanel;
	/** the mapping between Grappa nodes and model nodes will be kept in order to highlight, e.g., a node in the model */
	 ...
	 * @param aProcessModel the model to be visualized
	 */
	...
	public JPanel getPanel() {
		...
		// remember the mapping between grappa nodes and real nodes in order to find, e.g., transitions back
	...
	/**
	 * Helper method building the mapping between Grappa nodes and model elements.
	 * @param mapping the target map for the mapped elements
	 * @param g the subgraph to be mapped
	 */
	 ...
	 * @param vertices the graph vertices to be highlighted
	 */
	public void highLightNodesInVisualization(ArrayList<ModelGraphVertex> vertices) {
