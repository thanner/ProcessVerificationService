...
public class HLBinomialDistributionGui extends HLDistributionGui {
	...
	public HLBinomialDistributionGui(HLBinomialDistribution theParent) {
		super(theParent);
		myNumberExperiments = new GUIPropertyIntegerTextField("Number of experiments", 
				((HLBinomialDistribution) parent).getNumberOfExperiments(), 1, true, this);
	...
	public HLBinomialDistributionGui(HLGeneralDistribution theParent) {
		super(theParent);
		myNumberExperiments = new GUIPropertyIntegerTextField("Number of experiments", 
				((HLGeneralDistribution) parent).getNumberExperiments(), 1, true, this);
		myProbability = new GUIPropertyDoubleTextField("Probability value", 
	...
	public void updateGUI() {
		if (parent instanceof HLBinomialDistribution) {
			((HLBinomialDistribution) parent).setNumberOfExperiments(myNumberExperiments.getValue());
			((HLBinomialDistribution) parent).setProbability(myProbability.getValue());
		} else if (parent instanceof HLGeneralDistribution) {
			((HLGeneralDistribution) parent).setNumberExperiments(myNumberExperiments.getValue());
			((HLGeneralDistribution) parent).setProbability(myProbability.getValue());
		}
	}
