...
/**
 * Coordinates the high level elements for a process, whereas
 * <i>high level</i> is interpreted as being everything beyond
 * the <i>pure control flow</i>.
 * <br>
 ...
 * these characteristics (e.g., sojourn time of an activity includes execution time).
 * <br>
 * If the high level process information is to be related to elements in a concrete
 * process model then this can be done in the high level process implementation
 * for the corresponding process model type (e.g., HLPetriNet).
 * <br>
...
public class HLProcess implements Cloneable {
	 ...
	 * @param name the name of this HLProcess
	 */
	public HLProcess() {
		this("");
	}
	 ...
	 * @param id the ID for the requested activity
	 */
	 ...
	 * @param id the ID for the requested choice
	 */
	 ...
	 * @param id the ID for the requested attribute
	 */
	 ...
	 * @param id the ID for the requested group
	 */
	...
	/**
	 * Retrieves all groups that belong to this process.
	 * Note that this will not contain the "Nobody" or "Anybody" group.
	 * @see #getAllGroups()
	...
	public List<HLGroup> getGroups() {
		...
		for (HLGroup group : groups.values()) {
			if (anybodyHLID.equals(group.getID()) || nobodyHLID.equals(group.getID())) {
				continue;
			}
			result.add(group);
		}
	...
	/**
	 * Retrieves all groups that belong to this process, including "Anybody" and "Nobody" groups.
	 * @see #getGroups()
	 * @return the groups defined for this process including "Anybody" and "Nobody" groups
	 */
	...
	/**
	 * Adds the given high level activity to this process and sets the
	 * reference to this high level process.
	 * <br>
	 * If an object with the same ID is already contained in the process,
	 * its reference to this high level process will be removed, and it
	 * will be replaced.
	...
	public void addOrReplace(HLActivity act) {
         ...
         * reference to this high level process.
         * <br>
         * If an object with the same name is already contained in the process,
         * its reference to this high level process will be removed, and it
         * will be replaced.
         * @param act the new activity
         */
	...
	/**
	 * Adds the given high level choice to this process and sets the
	 * reference to this high level process.
	 * <br>
	 * If an object with the same ID is already contained in the process,
	 * its reference to this high level process will be removed, and it
	...
	/**
	 * Adds the given high level resource to this process and sets the
	 * reference to this high level process.
	 * <br>
	 * If an object with the same ID is already contained in the process,
	 * its reference to this high level process will be removed, and it
	...
	/**
	 * Removes the specified attribute from this process and
	 * removes the attribute from activities if they refer to it.
	 * @param id the ID of the attribute that should be removed
	...
	/**
	 * Removes the specified activity from this process and
	 * removes the activity from choices if they refer to it.
	 * @param id the ID of the activity that should be removed
	 ...
	 * @param id the ID of the choice that should be removed
	...
	/**
	 * Removes the specified group from this process and
	 * removes the group from activities if they refer to it.
	 * @see #removeGroupWithoutAffectingAssigmnets(HLID)
	 * @param id the ID of the group that should be removed
	...
	/**
	 * Removes the specified group from this process but does not
	 * remove the group ID from activities if they refer to it.
	...
	/**
	 * Removes the specified resource from this process and
	 * removes the resource from groups if they refer to it.
	...
	/**
	 * Replaces the specified attribute by the given new attribute.
	 * <br>
	 * All the references at activities and data expressions will be updated.
	 * @param oldAttID the ID of the attribute that should be replaced
	 * @param newAtt the new HLAttribute object
	...
	/**
	 * Replaces the specified activity by the given new activity.
	 * <br>
	 * All the references at choices will be updated.
	 * @param oldActID the ID of the activity that should be replaced
	 * @param newAct the new HLActivity object
	 * @return whether activity was found or not
	 */
	 ...
	 * @param oldChoiceID the ID of the choice that should be replaced
	 * @param newChoice the new HLChoice object
	 * @return whether choice was found or not
	 */
	...
	/**
	 * Replaces the specified group by the given new group.
	 * <br>
	 * All the references at activities will be updated.
	 * @param oldGroupID the ID of the group that should be replaced
	 * @param newGroup the new HLGroup object
	 * @return whether group was found or not
	 */
	...
	/**
	 * Replaces the specified resource by the given new resource.
	 * <br>
	 * All the references at groups will be updated.
	 * @param oldResID the ID of the group that should be replaced
	 * @param newResource the new HLResource object
	 * @return whether resource was found or not
	 */
	...
	/**
	 * Updates the HLID of the NobodyGroup.
	 * <br>
	 * NOTE: Do not call this method in other situations than when converting
	 * one type of high-level process to another. In this situation, the high-level
	 * process information of the source hlModel (including nobodyID) needs to be 
	 * re-constructed in the target hlModel. However, normally the ID management
	 * should not be touched as this can have unexpected side effects. 
	 */
	...
	/**
	 * Updates the HLID of the AnybodyGroup.
	 * <br>
	 * NOTE: Do not call this method in other situations than when converting
	 * one type of high-level process to another. In this situation, the high-level
	 * process information of the source hlModel (including anybodyID) needs to be 
	 * re-constructed in the target hlModel. However, normally the ID management
	 * should not be touched as this can have unexpected side effects. 
	 */
	 ...
	 * activity.
	 * <br>
	 * There may be more than one if the activity is involved in more than
	 * one choice.
	 * @param actID the ID of the activity for which the choices are requested
	 * @return the list of choice objects related to this activity.
	...
	public ArrayList<HLChoice> getChoicesForTargetActivity(HLID actID) {
         ...
         * @param attID the ID of the attribute for which the activities are requested
         * @return the list of activity objects using this data attribute.
         * The list can be empty
         */
	...
	public ArrayList<HLActivity> getActivitiesForInputAttribute(HLID attID) {
        ...
        /* Returns the first found group matching the given name.
	 * <p>Keep in mind that this is not deterministic as soon as
	 * there are more than one group with this name in the process
	 * @param name the name to match
	 * @return the first group with the same name if found,
	...
	public HLGroup findGroupByName(String name) {
        ...
        /* Returns the first found attribute matching the given name.
         * <p>Keep in mind that this is not deterministic as soon as
         * there are more than one attribute with this name in the process
         * @param name the name to match
	 ...
	 * <p>Keep in mind that this is not deterministic as soon as
	 * there are more than one activity with this name in the process
	 * @param name the name to match
	 * @return the first activity with the same name if found,
	 * <code>null</code> otherwise
	 */
	 ...
	 * <p>Keep in mind that this is not deterministic as soon as
	 * there are more than one choice with this name in the process
	 * @param name the name to match
	 * @return the first choice with the same name if found,
	 * <code>null</code> otherwise
	 */
