...
public class HLChiSquareDistributionGui extends HLDistributionGui {
	...
	public HLChiSquareDistributionGui(HLChiSquareDistribution theParent) {
		super(theParent);
		myDegreesFreedom = new GUIPropertyIntegerTextField("Degrees of freedom value", 
				((HLChiSquareDistribution) parent).getDegreesFreedom(), 1, true, this);
	}
	...
	public HLChiSquareDistributionGui(HLGeneralDistribution theParent) {
		super(theParent);
		myDegreesFreedom = new GUIPropertyIntegerTextField("Degrees of freedom value", 
				((HLGeneralDistribution) parent).getDegreesOfFreedom(), 1, true, this);
	}
	...
	public void updateGUI() {
		if (parent instanceof HLChiSquareDistribution) {
			((HLChiSquareDistribution) parent).setDegreesFreedom(myDegreesFreedom.getValue());
		} else if (parent instanceof HLGeneralDistribution) {
			((HLGeneralDistribution) parent).setDegreesOfFreedom(myDegreesFreedom.getValue());
		}
	}
