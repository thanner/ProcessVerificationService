 ...
 * <p>The parent will be automatically notified for changes, if it has been provided.
 */
public abstract class HLAttributeValueGui implements GuiDisplayable, GuiNotificationTarget {
	
	protected HLAttributeGui parent;

	/**
	 * Creates a new attribute GUI and registers the given parent. 
	 * <p>The parent will be automatically notified for changes.
	 * @param theParent
	 */
	...
	/**
	 * Sub classes should return the attribute value they are 
	 * providing the GUI for. 
	 */
