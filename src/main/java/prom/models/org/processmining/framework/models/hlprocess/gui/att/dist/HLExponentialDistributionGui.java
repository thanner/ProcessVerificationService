...
public class HLExponentialDistributionGui extends HLDistributionGui {
	...
	public HLExponentialDistributionGui(HLExponentialDistribution theParent) {
		...
		myMean = new GUIPropertyDoubleTextField("Mean value", 
				((HLExponentialDistribution) parent).getMean(), new GUIPropertyDoubleMeanListener());
		myIntensity = new GUIPropertyDoubleTextField("Intensity value", 
				((HLExponentialDistribution) parent).getIntensity(), new GUIPropertyDoubleIntensityListener());
		initialize();
	}
	...
	public HLExponentialDistributionGui(HLGeneralDistribution theParent) {
		super(theParent);
		myMean = new GUIPropertyDoubleTextField("Mean value", 
				((HLGeneralDistribution) parent).getMean(), new GUIPropertyDoubleMeanListener());
		myIntensity = new GUIPropertyDoubleTextField("Intensity value", 
				((HLGeneralDistribution) parent).getIntensity(), new GUIPropertyDoubleIntensityListener());
		initialize();
	}
	...
	protected void initialize() {
		...
		myParameters = new GUIPropertyListEnumeration("Properties", "Select one of the distributions available", parametersList, this);
	}
	 ...
	 * <p>Changes affect the "Intensity" property value.
	 */
	 ...
	 * <p>Changes affect the "Mean" property value.
	 */
	class GUIPropertyDoubleIntensityListener implements GuiNotificationTarget {
		public void updateGUI() {
			...
			if (parent instanceof HLExponentialDistribution) {
				((HLExponentialDistribution) parent).setIntensity(myIntensity.getValue());
			} else if (parent instanceof HLGeneralDistribution) {
