...
/**
 * Represents the GUI of a boolean distribution. 
 * Allows to specify the relative frequency of the possible values  
...
public class HLBooleanDistributionGui extends HLAttributeValueGui {
	 ...
	 * @param parent the parent attribute gui
	 */
	 ...
	 */
	public HLBooleanDistributionGui(HLBooleanDistribution dist, HLAttributeGui parent) {
		super(parent);
		if (dist != null) {
			trueValueFrequency = new GUIPropertyInteger("true", 
					"Increase the relative frequency to increase the likelihood of the value 'true'", 
					dist.getFrequency(true), 0, Integer.MAX_VALUE, this, 200, true);
			falseValueFrequency = new GUIPropertyInteger("false", 
					"Increase the relative frequency to increase the likelihood of the value 'false'", 
					dist.getFrequency(false), 0, Integer.MAX_VALUE, this, 200, true);
		} else {
			trueValueFrequency = new GUIPropertyInteger("true", 
					"Increase the relative frequency to increase the likelihood of the value 'true'", 
	...
	public JPanel getPanel() {
		if (panel == null) {
			...
			label.setToolTipText("<HTML>Specifies the relative frequency of <i>true</i> and <i>false</i> values<br>" + 
	...
	/*
	 * (non-Javadoc)
	 * @see org.processmining.framework.models.hlprocess.gui.HLAttributeValueGui#disable()
	 */
	public void disable() {
