 ...
 * The distribution will be graphically represented by two spinners representing the number of drawings and
 * the intensity value.
 * <br>
...
public class HLErlangDistributionGui extends HLDistributionGui {
    ...
    public HLErlangDistributionGui(HLErlangDistribution theParent) {
        super(theParent);
        myEmergenceEvents = new GUIPropertyIntegerTextField("Emergence of n events",
                ((HLErlangDistribution) parent).getEmergenceOfEvents(), 1, true, this);
        myIntensity = new GUIPropertyDoubleTextField("Intensity value",
                ((HLErlangDistribution) parent).getIntensity(), 0.00000000000001, true, this);
    }

    /**
     * Constructor providing a view onto the given meta distribution.
     * <p>Changes will be propagated directly back to the HLGeneralDistribution object.
     *
     * @param theParent the meta distribution underlying this view
     */
    public HLErlangDistributionGui(HLGeneralDistribution theParent) {
        super(theParent);
        myEmergenceEvents = new GUIPropertyIntegerTextField("Emergence of n events",
                ((HLGeneralDistribution) parent).getEmergenceofEvents(), 1, true, this);
        myIntensity = new GUIPropertyDoubleTextField("Intensity value",
                ((HLGeneralDistribution) parent).getIntensity(), 0.00000000000001, true, this);
    }

    /*
     * (non-Javadoc)
     * @see org.processmining.framework.models.hlprocess.gui.att.dist.HLDistributionGui#getPanel()
     */
    ...
    /*
     * (non-Javadoc)
     * @see org.processmining.framework.models.hlprocess.gui.att.dist.HLDistributionGui#updateGUI()
     */
    public void updateGUI() {
        if (parent instanceof HLErlangDistribution) {
            ((HLErlangDistribution) parent).setEmergenceOfEvents(myEmergenceEvents.getValue());
            ((HLErlangDistribution) parent).setIntensity(myIntensity.getValue());
        } else if (parent instanceof HLGeneralDistribution) {
            ((HLGeneralDistribution) parent).setEmergenceOfEvents(myEmergenceEvents.getValue());
            ((HLGeneralDistribution) parent).setIntensity(myIntensity.getValue());
        }
    }
