...
/**
 * Gui class for pre-conditions concerning one high level activity.
 * <br>
 * Allows to view and edit the condition characteristics
...
public class HLConditionGui {
     ...
     * Constructor.
     *
     * @param the associated high level condition
     */
     ...
     *
     * @param view the view that is requested for this condition
     ...
     * @author Anne Rozinat
     */
    public class HLDataConditionGui implements GuiNotificationTarget, GuiDisplayable {
        ...
        public HLDataConditionGui() {
            expression = new GUIPropertyStringArea("Data expression (precondition to enable branch)",
        ...
        public JPanel getPanel() {
            ...
            dependencyPanel.setLayout(new BoxLayout(dependencyPanel, BoxLayout.LINE_AXIS));
            dependencyPanel.add(new JLabel("Alternative branch:  " + conditionTarget.getName()));
        ...
        public void updateGUI() {
            ...
            // TODO: editable GUI that can be propagated back to the actual data expression
            // in the high level process (currently changing the string in the text area does
            // not have any effect on the data dependency - so it is not editable)
        }
     ...
     * @author Anne Rozinat
     */
    public class HLProbabilityConditionGui implements GuiNotificationTarget, GuiDisplayable {
        ...
        public HLProbabilityConditionGui() {
            probability = new GUIPropertyDouble("Probability",
     ...
     * @author Anne Rozinat
     */
    public class HLFrequencyConditionGui implements GuiNotificationTarget, GuiDisplayable {
        ...
        public HLFrequencyConditionGui() {
            frequencyProperty = new GUIPropertyInteger("Frequency",
        ...
        public JPanel getPanel() {
            ...
            JPanel dependencyPanel = new JPanel();
            dependencyPanel.setLayout(new BoxLayout(dependencyPanel, BoxLayout.LINE_AXIS));
            dependencyPanel.add(new JLabel("Alternative branch:  " + toString()));
            dependencyPanel.add(Box.createHorizontalGlue());
            resultPanel.add(dependencyPanel);
            resultPanel.add(Box.createRigidArea(new Dimension(0, 5)));
