...
/**
 * <p>A numeric attribute allows for integer values within a certain value range.
 * <p>The possible values can be specified according to a probabilistic distribution.
 *
 * @see HLAttribute
 */
public class HLNumericAttribute extends HLAttribute {
     ...
     * @param dist    the distribution of the possible values
     * @param initVal the initial value
     * @param aProc   the process this attribute belongs to
     */
    public HLNumericAttribute(String name, HLDistribution dist, int initVal, HLProcess aProc) {
        this(name, aProc);
    ...
    /**
     * Specifies the distribution of possible numeric values for the data attribute.
     *
     * @param dist the new possible numeric values for the data attribute
     */
    ...
    /**
     * Directly specifies the numeric value new initial value for this attribute.
     *
     * @param aValue the new initial value for the numeric data attribute
     */
     ...
     *
     * @return the distribution of possible numeric values for this data attribute
     */
    ...
    public boolean isValid(HLAttributeValue val) {
        ...
        return val instanceof HLNumericValue || val instanceof HLNumericDistribution;
    }
