...
/**
 * Represents the GUI of a nominal data attribute, i.e., the possible values correspond
 * to an enumeration of String values.
 */
public class HLAttributeNominalView implements GuiDisplayable {
    ...
    /**
     * Default constructor. Creates object based on values of
     * associated HLAttribute object.
     */
    public HLAttributeNominalView(HLNominalAttribute theParent) {
        ...
        possibleValuesNominal = new GuiPropertyStringIntegerMap(null, null,
                parent.getPossibleValues().getValuesAndFrequencies(), null, false);
    }
