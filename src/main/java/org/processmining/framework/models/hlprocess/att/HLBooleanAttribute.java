...
/**
 * A boolean data attribute only allows for the values <code>true</code> and <code>false</code>.
 * <p>The likelihood, or frequency, for each of these values is captured
...
public class HLBooleanAttribute extends HLAttribute {
     ...
     *
     * @param aValue the new initial value for the boolean data attribute
    ...
    public boolean isValid(HLAttributeValue val) {
        return val instanceof HLBooleanValue || val instanceof HLBooleanDistribution;
    }
