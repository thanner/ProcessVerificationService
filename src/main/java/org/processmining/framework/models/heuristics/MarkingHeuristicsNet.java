...
public class MarkingHeuristicsNet {
     ...
     * @throws NullPointerException whenever the net has disconnected elements. An element is disconnected
    ...
    /**
     * @throws NullPointerException  when inElement is not in the hash. I.e, inElement has OUT=[]
     * @throws NumberFormatException when outElement does not belong to the OUT set of inElement.
     */
    ...
    public boolean properlyCompleted() {
        return endPlace == 1 && numberTokens == 1;
    }
...
//>>>>>>>>>>>>>>>>>> Hint!!! I think that's why I don't run into problems...
    ...
    public boolean isEnabled(int element) {
        ...
        if (hNet.getInputSet(element).size() == 0) {
            ...
            return bestCombination.getNumberMissingTokens() <= 0;
        }
