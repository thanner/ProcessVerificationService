    ...
    public void toFile(OutputStream output) throws IOException {
        ...
        if (thereAreNonDanglingTasks) {
            ...
            for (int i = 0; i < startTasks.size(); i++) {
                line.append(nonDanglingTasks[startTasks.get(i)]).append(SETS_SEPARATOR);
            }
            line.append("\n");
            ...
            for (int i = 0; i < endTasks.size(); i++) {
                line.append(nonDanglingTasks[endTasks.get(i)]).append(SETS_SEPARATOR);
            }
            line.append("\n");
            ...
            for (int i = 0; i < reverseDuplicatesMapping.length; i++) {
                ...
                line.append(le.getModelElementName() + EVENT_SEPARATOR + le.getEventType());
