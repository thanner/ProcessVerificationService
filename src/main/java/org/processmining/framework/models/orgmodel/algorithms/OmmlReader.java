...
public class OmmlReader {
    ...
    private static void addOrgEntity(Element element) {
    ...
    private static void addImplication(Element element) {
    ...
    private static void addResource(Element element) {
        ...
        for (Iterator iterator = qualitites.iterator(); iterator.hasNext(); ) {
            ...
            if (orgentities.containsKey(qualityID)) {
                resource.addOrgEntity(orgentities.get(qualityID));
            } else {
    ...
    private static void addTaskEntity(Element element) {
        ...
        for (Iterator iterator = qualitites.iterator(); iterator.hasNext(); ) {
            ...
            String qualityID = hasQuality.getText();
            if (orgentities.containsKey(qualityID)) {
                task.addOrgEntity(orgentities.get(qualityID));
            } else {
                Message.add("OrgEntity (ID=\"" + qualityID + "\") does not exists. The OrgEntity is ignored", 3);
            }
        }
