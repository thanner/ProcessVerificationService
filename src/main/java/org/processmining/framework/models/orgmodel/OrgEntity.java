...
public class OrgEntity implements Cloneable {
    ...
    public static final ArrayList<String> ORGENTITYTYPE_ARRAYLIST = new ArrayList<String>(Arrays.asList(ORGENTITYTYPE_ORGUNIT, ORGENTITYTYPE_ROLE, ORGENTITYTYPE_MININGRESULT));
